...
class BotConstants:
    ...
    log_file_message_format = environ.get("LOG_FILE_MESSAGE_FORMAT", "{time:YYYY-MM-DD HH:mm:ss} | {level: <8} | {name} | {message}")
    ...
    github_repository = "https://github.com/Snipy7374/SnipyBot-CodeWithVincentServer"